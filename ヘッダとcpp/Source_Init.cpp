...
void Init() {
	...
	if(Loading_Par != 100.0f)
		str.SuperString(w100 * 50, h100 * 40, "“Ç‚Ýž‚Ý‚ñ‚®!", 0xffffff, 1, size * 2);
	DrawBox(w100 * 0, h100 * 55, w100 * 0 + w100 * Loading_Par, h100 * 60, 0x00ff00, true);
	DrawBox(w100 * 0, h100 * 55, w100 * 100, h100 * 60, 0xffff00, false);
	...
	else if (dungeon.flg) { dungeon.ImageInput(&dungeon); dungeon.flg = false; Loading_Par = 90.0f; }
	else if (ch.flg) { ch.Init(&ch); ch.flg = false; Loading_Par = 100.0f; }
